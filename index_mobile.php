...
<body style=" text-align:center; font-family:'font-family: Calibri, sans-serif'; color: white"  >
  ...
  <div class="container_mobile" style="background-color: rgba(80, 121, 167); font-family: Calibri, sans-serif " > 
   <div class="Home" >
  ...
  <div class="Info"  style ="font-family: Calibri, sans-serif" >
    ...
    <p > Maak vandaag een account maken en kom in contact met leipe mensen.  </p>
  </div>
  
  <div class="Register">
    <a href="login.php" style= "text-decoration: none;  " > <h4 style="background-color:  rgba(80, 121, 167); color: white; font-family: Calibri, sans-serif" > Login  </h4> </a>
    <a href="register.php" style= "text-decoration: none; " > <h4 style="background-color: rgba(80, 121, 167); color: white; font-family: Calibri, sans-serif"> Register</h4> </a>
