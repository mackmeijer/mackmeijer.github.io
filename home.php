...
<body style=" text-align:center; font-family:'font-family: Calibri, sans-serif'; color: white"  >
  ...
  <div class="container" style="background-color: rgba(80, 121, 167)" > 
   <div class="Home" >
  ...
  <div class="Register">
    <p > Press this button to visit your profile  </p>
    <a href="profile.php" style= "text-decoration: none;  " > <h4 style="background-color:  rgba(80, 121, 167); color: white; font-family: Calibri, sans-serif" > Profile </h4> </a>
    <p> Press this button to go the the global chat room! </p>
