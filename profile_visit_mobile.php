...
<head>
  ...
  <style>
    ...
    .container {
      ...
      grid-template-rows: 1fr 0.05fr 0.5fr 0.05fr 0.5fr 0.05fr 0.5fr 0.05fr 1fr;
      gap: 5px 5px;
      ...
      grid-template-areas:
        ...
        "bio bio bio bio bio"
        "interests_title interests_title interests_title interests_title interests_title"
        "interests interests interests interests interests"
        "chat_title chat_title chat_title chat_title chat_title"
  ...
  <div class="container">
    <div class="name" id="rcorners1">  
      <?php echo "<h3> $username </h3> ";
        ...
        // if user is admin show delete user option
        ...
        // if user is admin show make admin option
        if ($is_admin == 1 && $visiting_is_admin == 0) {
          echo ' <form method="post">
    ...
    <div class="chat" id="rcorners1"> 
      ...
      <div class="textarea">
        ...
        <form name = "krabbel_msg" action = "" method = "post" value = "" > 
          <input type="text" maxlength="50" size="30" name="krabbel_msg" style="border-radius: 4px"> </input>   
    ...
    <div class="interests" id="rcorners1"> 
      ...
      <div class="friend_area" >
        <h4> Currently following: </h4>
          <?php
            // fetch visited user following list
