...
<head>
  ...
  <style>
    ...
    .container {
      ...
      grid-template-rows: 1fr 0.2fr 1fr 0.2fr 1fr 0.2fr 1fr 0.2fr 1fr;
      gap: 5px 5px;
  ...
  <body style="background-color: <?php echo $back; ?> ;text-align:center">  
    ...
    <div class="interests" id="rcorners1"> 
      ...
      <?php
        ...
        //produces link to requested profile
        else {
          $visiting_username = $row['username'];
          $visiting_id = $row['id'];
          $_SESSION["visiting_id"] = $visiting_id;
          echo '<a href="profile_visit_mobile.php"> visit: '.$visiting_username.   '</a>';
          }
        }
      ?>
